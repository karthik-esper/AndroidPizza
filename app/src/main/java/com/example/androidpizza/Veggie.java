...
/**
 * Subclass of Pizza that represents the Veggie pizza option.
 * @author Karthik Gangireddy, Vineal Sunkara
 */
public class Veggie extends Pizza {
    private static final double BASE_PRICE = 13.99; // Base price of the pizza
     ...
     * @return topping list for a Veggie pizza.
     */
