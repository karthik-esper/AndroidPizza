...
/**
 * Subclass of Pizza that represents the Hawaiian pizza option.
 * @author Karthik Gangireddy, Vineal Sunkara
 */
public class Hawaiian extends Pizza{
    private static final double BASE_PRICE = 12.99; // Base price of the pizza
     ...
     * @return topping list for a Hawaiian pizza.
     */
