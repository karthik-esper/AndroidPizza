...
/**
 * Subclass of Pizza that represents the Surf and Turf pizza option.
 * @author Karthik Gangireddy, Vineal Sunkara
 */
public class SurfTurf extends Pizza{
    private static final double BASE_PRICE = 18.99; // Base price of the pizza
